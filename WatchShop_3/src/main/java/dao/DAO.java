...
public class DAO 
{
    ...
    public void signup (String id, String email, String pass , String fullname)
    { 
      ...
      public List<Product> getallProductbyPrice ()
    {
        ...
        public void Order (Account a , Cart cart)
        {
            ...
            String query = "insert into orderr values (1,?,?,?)";
            try
            {
                conn = new DBcontext().getConnection();
                ps = conn.prepareStatement(query);
                ...
                ps.executeUpdate();
                String query2 = "select cid from orderr order by id desc";
        ...
        public List<Product> getallProductbypage (int index)
    {
        ...
        public void insertProduct(String id, String image, String name, String price, String description){
            String query = "INSERT INTO ClockData VALUES (?,?,?,?,?)";
            try {
            conn = new DBcontext().getConnection();
            ps = conn.prepareStatement(query);
            ps.setString(1,id);
