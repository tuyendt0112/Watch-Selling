<%-- 
    Document   : detail
    Created on : Nov 17, 2022, 10:32:42 AM
    Author     : Legion
--%>
                    ...
                    <div class="properties__button">
                        ...
                        <nav>                                                      
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"> Giá Từ Cao Đến Thấp</a>
                                ...
                                <aside class="col-sm-5 border-right">
                                    <article class="gallery-wrap"> 
                                        <div class="img-big-wrap">
                                            <div> <a href="#"><img src=${detail.image} style="width:350px;height:500px;"></a></div>
                                        </div> <!-- slider-product.// -->
                                    ...
                                    <article class="card-body p-5">
                                        ...
                                        <p class="price-detail-wrap"> 
                                            <span class="price h3 text-warning"> 
                                                <span class="currency"></span><span class="num">$<fmt:formatNumber pattern="##.#" value = "${detail.price}"/></span>
                                            </span> 
                                        </p> <!-- price-detail-wrap .// -->
                                        ...
                                        <a href="BuyServlet?id=${detail.id}&num=${1}" class="btn btn-lg btn-outline-primary text-uppercase"> <i class="fas fa-shopping-cart"></i> Add to cart </a>
                                    </article> <!-- card-body.// -->
                                </aside> <!-- col.// -->
                            </div> <!-- row.// -->
                        </div> <!-- card.// -->
